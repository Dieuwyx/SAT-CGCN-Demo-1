...
class Attention(gnn.MessagePassing):
    ...
    def forward(self,
        ...
        v = self.to_v(x)
        # print('这里是attention里的x，位于x_struct之前',x.shape)
        ...
        # print('这里是attention里的x_struct',x_struct.shape)
...
class StructureExtractor(nn.Module):
    ...
    def forward(self, x, edge_index, edge_attr=None,
        ...
        if self.khopgnn:
            ...
            # print('这里是StructureExtractor中的x，传递给x_struct',x.shape)
            return x
...
class KHopStructureExtractor(nn.Module):
    ...
    def forward(self, x, edge_index, subgraph_edge_index, edge_attr=None,
        ...
        # print('before x_struct = torch.cat([x, x_struct], dim=-1)  check x and x_struct')
        # print('这里是KHopStructureExtractor的x_struct-------------->',x_struct.shape)
        # print('这里是KHopStructureExtractor的x-------------------->',x.shape)
...
class TransformerEncoderLayer(nn.TransformerEncoderLayer):
    ...
    def forward(self, x, edge_index, complete_edge_index,
        ...
        # print('这里是TransformerEncoderlayer的x',x.shape)
        return x
